...
describe("Parser", function() {
  ...
  var testPayload = new Buffer.from([27, 2, 1, 6, 17, 6, 186, 86, 137, 166, 250, 191, 162, 189, 1, 70, 125, 110, 56, 88, 171, 173, 5, 22, 10, 24, 7, 4]);
  ...
  describe("#parse()", function() {
    ...
    it("should be able to switch byte order of bytes based on endian-ness", function() {
      var newPayload = Buffer.from([ 7, 2, 1, 6, 3, 2, 160, 255 ]);
